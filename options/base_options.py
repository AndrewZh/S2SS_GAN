...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--gpu_ids', type=str, default='0,2', help='gpu ids: e.g. 0  0,1,2, 0,2. use -1 for CPU')
        ...
        parser.add_argument('--crop_size', type=int, default=50, help='Crop to the width of crop_size (after initially scaling the images to load_size.)')
        ...
        parser.add_argument('--semantic_nc', type=int, default=1, help='# of semantic image channels')
        parser.add_argument('--samples_per_volume', type=int, default=200, help='# samples per subject')

        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='/data/s2,s')
        parser.add_argument('--dataset_mode', type=str, default='s2ms')
